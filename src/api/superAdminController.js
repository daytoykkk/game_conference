...
// 审核公司通过
export const passCompanyReq = (id) => ajax('/superAdmin/passCompany',id,'POST','',"application/json");

// 解决账户
export const unFreezeUserReq = (username) => ajax('/superAdmin/unFreezeUser',{"JsonUsername":username},'PUT');

// 审核公司不通过
export const unPassCompanyReq = (id) => ajax('/superAdmin/unPassCompany',id,'POST','',"application/json");